    ...
    >
      <div className="header-container">
        <nav className="main-nav">
          <ul>
            <li>
              <Link href="/home" className="nav-link" onClick={closeNav}>
                <Image src={home} alt="home" />
                <span>{t("navigation.home")}</span>
              </Link>
            </li>
            <li>
              <Link href="/shop?page=1" className="nav-link" onClick={closeNav}>
            ...
            <li className="mobile-menu-user-actions">
              <div className="user-menu">
                <UserMenu onMenuAction={closeNav} />
              </div>
              <CartIcon onCartClick={closeNav} />
