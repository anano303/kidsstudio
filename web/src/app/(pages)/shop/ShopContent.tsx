...
const ShopContent = () => {
  ...
  const productsHeaderRef = useRef<HTMLDivElement>(null); // პროდუქტების სათაურისთვის რეფერენსი
  ...
  const handleCategoryChange = useCallback(
    (categoryId: string) => {
      // მხოლოდ მაშინ ავარესეტოთ page თუ კატეგორია რეალურად იცვლება
  ...
  const handleSubCategoryChange = useCallback(
    (subcategoryId: string) => {
      const previousSubCategory = selectedSubCategoryId;
      ...
      // პროდუქტების სათაურამდე scroll მხოლოდ თუ რეალურად იცვლება subcategory
      if (subcategoryId && subcategoryId !== previousSubCategory && productsHeaderRef.current) {
        setTimeout(() => {
        ...
        <div className="shop-layout">
          <div className="filters-sidebar">
            <ProductFilters
              ...
              onScrollToProducts={() => {
                // პროდუქტების სათაურამდე scroll ფილტრის დადასტურების შემდეგ
          ...
          <div className="products-area">
            {/* პროდუქტების სათაური */}
            <div ref={productsHeaderRef} className="products-header">
              <h2 className="products-title">{t("shop.products")}</h2>
            </div>
